...
class Spectral(nn.Module):
    ...
    def pruning_diag(self, 
                     ...
                     base_grad: bool = True):
        """
        This method apply a pruning procedure, acting directly on the elements in the diagonal of this class. In order to mantein pruned structure
        start_grad and end_grad should be required False
